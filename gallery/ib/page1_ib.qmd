...
<iframe allowfullscreen width="900" height="480" loading="lazy" frameborder="0" src="https://p3d.in/e/G0Eog" alt="Image 3D de corail">
...
m <- leaflet() %>%
    ...
    addMarkers(lng=45.17146, lat=-12.71570, popup="Ile blanche")
m  # Print the map
```
