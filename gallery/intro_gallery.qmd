...
ou en choisissant un des sites d'échantillonnage du projet ([Aéroport](listing_site.html#aeroport), [Île Blanche](listing_site.html#ile-blanche), [Surprise](listing_site.html#surprise), [Ngouja](listing_site.html#ngouja) ou [Jolly Roger](listing_site.html#joly-roger), par exemple en vous servant de la carte ci-dessous :
